...
class DWDHistoricalFormat:
    """
    Information on DWD historical data:
    see readme
...
def DWD_historical_to_core_data(
    ...
    """
    format_DWD_historical = DWDHistoricalFormat.import_format()
...
def DWD_forecast_2_core_data(df_import: pd.DataFrame, meta: MetaData) -> pd.DataFrame:
    ...
    Returns:
        pd.DataFrame: The transformed DataFrame in the core data format.
    """
    format_DWD_forecast = DWDForecast.import_format()
