...
htmlhelp_basename = 'AixWeatherdoc'
...
latex_documents = [
    (master_doc, 'AixWeather.tex', 'AixWeather Documentation',
     'EON EBC', 'manual'),
]
...
man_pages = [
    (master_doc, 'AixWeather', 'AixWeather Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'AixWeather', 'AixWeather Documentation',
     author, 'AixWeather', 'One line description of project.',
     'Miscellaneous'),
]
